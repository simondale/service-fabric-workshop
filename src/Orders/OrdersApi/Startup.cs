...
namespace OrdersApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options => options.SwaggerDoc("v1", new Info { Title = "Orders", Description = "Orders API" }));
        }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(options => options.SwaggerEndpoint("v1/swagger.json", "Orders API"));
            app.UseMvc();
        }
    }
}
